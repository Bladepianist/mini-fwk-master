			...
			<tr class='table-striped'>
				...
				<td>
					...
					<a class='glyphicon glyphicon-search' 
						...
						href='?module=CRUDUE&action=detail&id={$donnees.idUE}&displayModuleInDialog=1'>
					</a> 				
					...
					<a class='glyphicon glyphicon-pencil' 
						data-toggle="modal" 
						data-target="#inclusion"
						href='?module=CRUDUE&action=modifier&id={$donnees.idUE}&displayModuleInDialog=1'>
					</a>

					<!--supprimer-->
					<a class='glyphicon glyphicon-remove' title='Supprimer {$donnees.nomUE}' 
						href='?module=CRUDUE&action=supprimer&id={$donnees.idUE}'></a>				
				</td>
			</tr>
		{foreachelse}	
