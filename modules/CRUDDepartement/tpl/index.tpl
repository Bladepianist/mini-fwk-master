	...
	<table class='table table-striped'>
		...
		{foreach $data as $ligne=>$donnees}
			<tr class='table-striped'>
				<td>{$donnees.idDepartement}</td>
				<td>{$donnees.nomDepartement}</td>
				<td>
					<!--voir le détail-->
					<a class='glyphicon glyphicon-search' 
						data-toggle="modal" 
						data-target="#inclusion" 
						href='?module=CRUDDepartement&action=detail&id={$donnees.idDepartement}&displayModuleInDialog=1'>
					</a> 				
					...
					<a class='glyphicon glyphicon-pencil' 
						data-toggle="modal" 
						data-target="#inclusion"
						href='?module=CRUDDepartement&action=modifier&id={$donnees.idDepartement}&displayModuleInDialog=1'>
					</a>

					<!--supprimer-->
					<a class='glyphicon glyphicon-remove' title='Supprimer {$donnees.nomDepartement}' 
						href='?module=CRUDDepartement&action=supprimer&id={$donnees.idDepartement}'></a>				
				</td>
			</tr>
		{foreachelse}	
