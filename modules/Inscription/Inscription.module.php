...
class Inscription extends Module{
	...
	public function action_index(){
		...
		$this->set_title("Inscription"); //OK
		$f=new Form("?module=Inscription&action=valide","form_inscrip"); //OK
		...
		$f->add_select("idGroupeUtilisateur", "idGroupeUtilisateur", "Spécialisation")-> set_required(); //idem que ci-dessus
		// Traitement AJAX. Filtrer en fonction du Département choisi
		$f->add_checkbox("conditionUtilisateur","conditionUtilisateur","Acceptez-vous les Conditions d'Utilisateur")->set_value("off")-> set_required();	//OK
