	...
	<table class='table table-striped'>
		...
		{foreach $data as $ligne=>$donnees}
			<tr class='table-striped'>
				...
				<td>{$donnees.dateArticle}</td>
				<td>
					<!--voir le détail-->
					<a class='glyphicon glyphicon-search' 
						data-toggle="modal" 
						data-target="#inclusion"
						href='?module=CRUDArticle&action=detail&id={$donnees.idArticle}&displayModuleInDialog=1'>
					</a> 				
					...
					<a class='glyphicon glyphicon-pencil' 
						data-toggle="modal" 
						data-target="#inclusion"
						href='?module=CRUDArticle&action=modifier&id={$donnees.idArticle}&displayModuleInDialog=1'>
					</a>

					<!--supprimer-->
					<a class='glyphicon glyphicon-remove' title='Supprimer Article {$donnees.idArticle}' 
						href='?module=CRUDArticle&action=supprimer&id={$donnees.idArticle}'></a>				
				</td>
			</tr>
		{foreachelse}	
